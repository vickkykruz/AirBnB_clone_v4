...
def states():
    """ This is a function that return the render_template the states """
...
def states_id(id):
    """ This is a function that return the render_template that conatins the
        cities otherwise not found
    """
